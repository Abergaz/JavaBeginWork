...
public class GoldMan extends AbstractMovingObject {
    ...
    public GoldMan(Coordinate coordinate) {
        ...
        super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_7h/images/goldman_up.png"));
    }
    ...
    public void changeIcon(MovingDirection direction) {
        switch (direction) {
            case DOWN:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_7h/images/goldman_down.png"));
                break;
            case LEFT:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_7h/images/goldman_left.png"));
                break;
            case RIGHT:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_7h/images/goldman_right.png"));
                break;
            case UP:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_7h/images/goldman_up.png"));
                break;
