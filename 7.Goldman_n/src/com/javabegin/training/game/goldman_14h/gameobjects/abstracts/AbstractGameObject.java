package com.javabegin.training.game.goldman_14h.gameobjects.abstracts;
...
import com.javabegin.training.game.goldman_14h.gameobjects.interfaces.StaticObject;
...
public abstract class AbstractGameObject implements StaticObject, Serializable {
    ...
    private ImageIcon icon = getImageIcon("/com/javabegin/training/game/goldman_14h/images/noicon.png");// изображение по-умолчанию
