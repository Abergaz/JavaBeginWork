package com.javabegin.training.game.goldman_10h.gameobjects.abstracts;
...
import com.javabegin.training.game.goldman_10h.gameobjects.interfaces.StaticObject;
...
public abstract class AbstractGameObject implements StaticObject, Serializable {
    ...
    private ImageIcon icon = getImageIcon("/com/javabegin/training/game/goldman_10h/images/noicon.png");// изображение по-умолчанию
