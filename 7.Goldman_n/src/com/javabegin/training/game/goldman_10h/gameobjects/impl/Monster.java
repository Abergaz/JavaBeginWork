...
import com.javabegin.training.game.goldman_10h.gameobjects.abstracts.AbstractSoundObject;
...
public class Monster extends AbstractSoundObject {
    ...
    public Monster(Coordinate coordinate) {
        ...
        super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_10h/images/monster_up.jpg"));// иконку по-умолчанию (можно сделать реализацию случайного выбора иконки)
    ...
    public void changeIcon(MovingDirection direction) {
        switch (direction) {
            case DOWN:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_10h/images/monster_down.jpg"));
                break;
            case LEFT:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_10h/images/monster_right.jpg"));
                break;
            case RIGHT:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_10h/images/monster_right.jpg"));
                break;
            case UP:
                super.setIcon(getImageIcon("/com/javabegin/training/game/goldman_10h/images/monster_up.jpg"));
                break;
        }
    }
