package com.javabegin.training.game.goldman_12h.gameobjects.abstracts;
...
import com.javabegin.training.game.goldman_12h.gameobjects.interfaces.StaticObject;
...
public abstract class AbstractGameObject implements StaticObject, Serializable {
    ...
    private ImageIcon icon = getImageIcon("/com/javabegin/training/game/goldman_12h/images/noicon.png");// изображение по-умолчанию
