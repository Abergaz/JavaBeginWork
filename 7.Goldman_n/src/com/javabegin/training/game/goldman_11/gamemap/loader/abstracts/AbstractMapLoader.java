package com.javabegin.training.game.goldman_11.gamemap.loader.abstracts;
...
import com.javabegin.training.game.goldman_11.creators.GameObjectCreator;
...
public abstract class AbstractMapLoader implements MapLoader {
    ...
    protected void createGameObject(String str, Coordinate coordinate) {
        ...
        GameObjectType type = GameObjectType.valueOf(str.toUpperCase().trim());
