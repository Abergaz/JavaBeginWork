package ru.javabegin.demo.ConnectSQLiteJDBC_12;
...
public class Start {
    ...
    public static void main(String[] args) {
        try {
            ...
            Scanner scanner = new Scanner(new FileInputStream("D:\\JavaBeginWork\\5. BD_n\\src\\ru\\javabegin\\demo\\ConnectSQLiteJDBC_12\\sql.txt"), "UTF-8");
