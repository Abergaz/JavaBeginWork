 ...
 *----------------------------------------------------------------------
 */
package ru.javabegin.training.l2_jlgui.player;
...
import ru.javabegin.training.l2_jlgui.player.equalizer.ui.EqualizerUI;
import ru.javabegin.training.l2_jlgui.player.playlist.Playlist;
import ru.javabegin.training.l2_jlgui.player.playlist.PlaylistFactory;
import ru.javabegin.training.l2_jlgui.player.playlist.PlaylistItem;
import ru.javabegin.training.l2_jlgui.player.playlist.ui.PlaylistUI;
import ru.javabegin.training.l2_jlgui.player.skin.*;
import ru.javabegin.training.l2_jlgui.player.tag.ui.TagSearch;
import ru.javabegin.training.l2_jlgui.player.util.Config;
import ru.javabegin.training.l2_jlgui.player.util.FileSelector;
import ru.javabegin.training.l2_jlgui.player.util.ui.Preferences;
import ru.javabegin.training.l2_jlgui.player.visual.util.SpectrumTimeAnalyzer;
...
public class PlayerUI extends JPanel implements ActionListener, ChangeListener, BasicPlayerListener
{
    ...
    public void loadSkin()
    {
        ...
        else
        {
            ...
            InputStream sis = cl.getResourceAsStream("ru/javabegin/training/l2_jlgui/player/metrix.wsz");
    ...
    public boolean loadPlaylist(String playlistName)
    {
        ...
        if (playlist == null)
        {
            config.setPlaylistClassName("ru.javabegin.training.l2_jlgui.player.playlist.BasePlaylist");
            playlist = plf.getPlaylist();
        }
