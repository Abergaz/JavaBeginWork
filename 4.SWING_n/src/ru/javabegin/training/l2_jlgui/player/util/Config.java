 ...
 *----------------------------------------------------------------------
 */
package ru.javabegin.training.l2_jlgui.player.util;

import ru.javabegin.training.l2_jlgui.player.util.ini.Configuration;
...
public class Config
{
    ...
    private String _playlist = "ru.javabegin.training.l2_jlgui.player.playlist.BasePlaylist";
    private String _taginfoMpeg = "ru.javabegin.training.l2_jlgui.player.tag.MpegInfo";
    private String _taginfoOggVorbis = "ru.javabegin.training.l2_jlgui.player.tag.OggVorbisInfo";
    private String _taginfoAPE = "ru.javabegin.training.l2_jlgui.player.tag.APEInfo";
    private String _taginfoFlac = "ru.javabegin.training.l2_jlgui.player.tag.FlacInfo";
