 ...
 *----------------------------------------------------------------------
 */
package ru.javabegin.training.l2_jlgui.player.tag;
...
import ru.javabegin.training.l2_jlgui.player.tag.ui.*;
...
public class TagInfoFactory
{
    ...
    private TagInfoFactory()
    {
        ...
        if (MpegTagInfoClass == null)
        {
            ...
            MpegTagInfoClass = getTagInfoImpl("ru.javabegin.training.l2_jlgui.player.tag.MpegInfo");
        }
        ...
        {
            log.error("Error : TagInfo implementation not found in " + classname + " hierarchy");
            VorbisTagInfoClass = getTagInfoImpl("ru.javabegin.training.l2_jlgui.player.tag.OggVorbisInfo");
        }
        ...
        {
            log.error("Error : TagInfo implementation not found in " + classname + " hierarchy");
            APETagInfoClass = getTagInfoImpl("ru.javabegin.training.l2_jlgui.player.tag.APEInfo");
        }
        ...
        {
            log.error("Error : TagInfo implementation not found in " + classname + " hierarchy");
            FlacTagInfoClass = getTagInfoImpl("ru.javabegin.training.l2_jlgui.player.tag.FlacInfo");
        }
    }
        ...
        if (classname != null)
        {
            try
            {
                ...
                while (superClass != null)
                {
                    ...
                    {
                        if ((interfaces[i].getName()).equals("ru.javabegin.training.l2_jlgui.player.tag.TagInfo"))
                        {
                            interfaceFound = true;
                            break;
                        }
