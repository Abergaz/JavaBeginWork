 ...
 *----------------------------------------------------------------------
 */
package ru.javabegin.training.l2_jlgui.player.skin;
...
import ru.javabegin.training.l2_jlgui.player.equalizer.ui.SplinePanel;
...
public class Skin
{
    ...
    {
        super();
        String i18n = "ru/javabegin/training/l2_jlgui/player/skin/skin";
    ...
    public void loadSkin(String skinName)
    {
        ...
        catch (Exception e)
        {
            ...
            InputStream sis = this.getClass().getClassLoader().getResourceAsStream("ru/javabegin/training/l2_jlgui/player/metrix.wsz");
