 ...
 */
package ru.javabegin.training.l2_mp3player_part1.gui;

import ru.javabegin.training.l2_mp3player_part1.utils.SkinUtils;
...
public class MP3PlayerGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnStopSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/stop-red-icon.png"))); // NOI18N
        btnStopSong.setToolTipText("Остановить");

        btnPauseSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/Pause-icon.png"))); // NOI18N
        btnPauseSong.setToolTipText("Пауза");

        btnPlaySong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/Play.png"))); // NOI18N
        btnPlaySong.setToolTipText("Воспроизвести");
        btnPlaySong.setName("btnPlay");

        btnNextSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/next-icon.png"))); // NOI18N
        ...
        tglbtnVolume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/speaker.png"))); // NOI18N
        tglbtnVolume.setToolTipText("Выключить звук");
        tglbtnVolume.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/mute.png"))); // NOI18N

        btnPrevSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/prev-icon.png"))); // NOI18N
        btnPrevSong.setToolTipText("Предыдущая песня");

        btnAddSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/plus_16.png"))); // NOI18N
        ...
        btnDeleteSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/remove_icon.png"))); // NOI18N
        ...
        btnSelectPrev.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/arrow-down-icon.png"))); // NOI18N
        ...
        btnSelectNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/arrow-up-icon.png"))); // NOI18N
        ...
        btnSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/search_16.png"))); // NOI18N
        ...
        menuOpenPlaylist.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/open-icon.png"))); // NOI18N
        menuOpenPlaylist.setText("Открыть плейлист");
        menuOpenPlaylist.setName("");
        menuFile.add(menuOpenPlaylist);

        menuSavePlaylist.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/save_16.png"))); // NOI18N
        menuSavePlaylist.setText("Сохранить плейлист");
        menuFile.add(menuSavePlaylist);
        menuFile.add(menuSeparator);

        menuExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/exit.png"))); // NOI18N
        ...
        menuChangeSkin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ru/javabegin/training/l2_mp3player_part1/images/gear_16.png"))); // NOI18N
